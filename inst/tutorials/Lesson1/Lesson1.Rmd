...
consultations_gp <- read_delim(
  here("data", "Consultations_cleaned2021-09-03.txt"),
  delim = "\t",
...
This is publicly available data from SSB (Norwegian Statistics Bureau) on number of consultations at general practitioners (GP) between 2012 and 2018.
